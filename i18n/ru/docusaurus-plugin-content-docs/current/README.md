[✔](./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png): assets/images/checkbox-small-blue.png
...
Читайте на других языках: [![CN](./assets/flags/CN.png)**CN**](./README.chinese.md), [![BR](./assets/flags/BR.png)**BR**](./README.brazilian-portuguese.md), [![RU](./assets/flags/RU.png)**RU**](./README.md), [![EU](./assets/flags/EU.png)**EU**](./README.basque.md) [(![ES](./assets/flags/ES.png)**ES**, ![FR](./assets/flags/FR.png)**FR**, ![HE](./assets/flags/HE.png)**HE**, ![KR](./assets/flags/KR.png)**KR** and ![TR](./assets/flags/TR.png)**TR** in progress! )](#translations)
...
- **🇷🇺 Перевод на русский:** Alex Ivanov недавно опубликовал [Russian translation](./README.md)
...
## ![✔](./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png) 1.1 Структурируйте свое решение по компонентам
...
🔗 [**Подробнее: Структурируйте свое решение по компонентам**](./sections/projectstructre/breakintcomponents.md)
...
🔗 [**Подробнее: Выделяйте ваши компоненты в отдельный слой, держите Express в его границах**](./sections/projectstructre/createlayers.md)
...
🔗 [**Подробнее: Оборачивайте общие утилиты в пакеты npm**](./sections/projectstructre/wraputilities.md)
...
🔗 [**Подробнее: Разделяйте Express "приложение" и "сервер"**](./sections/projectstructre/separateexpress.md)
...
🔗 [**Подробнее: Используйте конфигурацию с учетом среды, безопасную и иерархическую конфигурацию**](./sections/projectstructre/configguide.md)
...
🔗 [**Подробнее: Используйте Async-Await или обещания для асинхронной обработки ошибок**](./sections/errorhandling/asyncerrorhandling.md)
...
🔗 [**Подробнее: Используйте только встроенный объект Error**](./sections/errorhandling/useonlythebuiltinerror.md)
...
🔗 [**Подробнее: Различайте операционные ошибки и ошибки программиста**](./sections/errorhandling/operationalvsprogrammererror.md)
...
🔗 [**Подробнее: Обрабатывайте ошибки централизованно. Не в промежуточных слоях**](./sections/errorhandling/centralizedhandling.md)
...
🔗 [**Подробнее: Документироваие ошибок API при использовании Swagger или GraphQL**](./sections/errorhandling/documentingusingswagger.md)
...
🔗 [**Подробнее: Изящно выходите из процесса, когда неизвестное случается**](./sections/errorhandling/shuttingtheprocess.md)
...
🔗 [**Подробнее: Используйте проверенный логгер, чтобы увеличить видимость ошибок**](./sections/errorhandling/usematurelogger.md)
...
🔗 [**Подробнее: Тестируйте потоки ошибок с использованием вашей любимой тестовой среды**](./sections/errorhandling/testingerrorflows.md)
...
🔗 [**Подробнее: Обнаружение ошибок и простоев с использованием продуктов APM**](./sections/errorhandling/apmproducts.md)
...
🔗 [**Подробнее: Перехватывайте необработанные отказы от обещаний**](./sections/errorhandling/catchunhandledpromiserejection.md)
...
🔗 [**Подробнее: Быстро проваливайтесь, проверяя аргументы, используя выделенную библиотеку**](./sections/errorhandling/failfast.md)
...
🔗 [**Подробнее: возвращение промисов**](./sections/errorhandling/returningpromises.md)
...
🔗 [**Подробнее: Использование ESLint и Prettier**](./sections/codestylepractices/eslint_prettier.md)
...
🔗 [**Подробнее: Включите 3 части в каждое название теста**](./sections/testingandquality/3-parts-in-name.md)
...
🔗 [**Подробнее: Избегайте глобальных тестовых приспособлений и параметров, добавляйте данные для каждого теста**](./sections/testingandquality/avoid-global-test-fixture.md)
...
🔗 [**Подробнее: Тщательно выбирайте платформу CI**](./sections/testingandquality/citools.md)
...
🔗 [**Подробнее: Сделайте ваше приложение прозрачным, используя умные логи**](./sections/production/smartlogging.md)
...
🔗 [**Подробнее: Делегируйте все возможное (например, gzip, SSL) обратному прокси**](./sections/production/delegatetoproxy.md)
...
🔗 [**Подробнее: Блокируйте зависимости**](./sections/production/lockdependencies.md)
...
🔗 [**Подробнее: Защищайте и перезапускайте свой процесс в случае неудачи (используя правильный инструмент)**](./sections/production/guardprocess.md)
...
🔗 [**Подробнее: Создавайте конечную точку обслуживания**](./sections/production/createmaintenanceendpoint.md)
...
🔗 [**Подробнее: Уверенный пользовательский опыт с продуктами APM**](./sections/production/apmproducts.md)
...
🔗 [**Подробнее: Делайте ваш код готовым к работе**](./sections/production/productioncode.md)
...
🔗 [**Подробнее: Измеряйте и защищайте использование памяти**](./sections/production/measurememory.md)
...
🔗 [**Подробнее: Получайте ваши внешние ресурсы вне Node**](./sections/production/frontendout.md)
...
🔗 [**Подробнее: Используйте инструменты, которые автоматически обнаруживают уязвимые зависимости**](./sections/production/detectvulnerabilities.md)
...
🔗 [**Read More: Назначьте "TransactionId" для каждого вхождения журнала логирования**](./sections/production/assigntransactionid.md)
...
🔗 [**Подробнее: Используйте LTS-релиз Node.js в производстве**](./sections/production/LTSrelease.md)
...
🔗 [**Подробнее: Код вашего приложения не должен обрабатывать журналы маршрутизации**](./sections/production/logrouting.md)
...
🔗 [**Подробнее: Пользуйтесь правилами безопасности линтера**](./sections/security/lintrules.md)
...
🔗 [**Подробнее: Ограничивайте одновременные запросы с использованием балансировщика или промежуточного программного обеспечения**](./sections/security/limitrequests.md)
...
🔗 [**Подробнее: Извлекайте секреты из конфигурационных файлов или используйте пакет npm, который их шифрует**](./sections/security/secretmanagement.md)
...
🔗 [**Подробнее: Предотвращайте уязвимости при внедрении базы данных с помощью библиотек ORM/ODM или других пакетов DAL**](./sections/security/ormodmusage.md)
...
🔗 [**Подробнее: Общие рекомендации по безопасности Node.js**](./sections/security/commonsecuritybestpractices.md)
...
🔗 [**Подробнее: Используйте связанные с безопасностью заголовки для защиты вашего приложения от распространенных атак**](./sections/security/secureheaders.md)
...
🔗 [**Подробнее: Постоянно и автоматически проверяйте наличие уязвимых зависимостей**](./sections/security/dependencysecurity.md)
...
🔗 [**Подробнее: Не используйте криптографическую библиотеку Node.js для паролей, используйте Bcrypt**](./sections/security/bcryptpasswords.md)
...
🔗 [**Подробнее: Экранируйте вывод**](./sections/security/escape-output.md)
...
🔗 [**Подробнее: Реализовывайте поддержку внесения JWT в черный список**](./sections/security/expirejwt.md)
...
🔗 [**Подробнее: Предотвращайте атаки методом грубой силы против авторизации**](./section/security/login-rate-limit.md)
...
🔗 [**Подробнее: Ограничивайте размер полезной нагрузки с помощью обратного прокси или промежуточного ПО**](./sections/security/requestpayloadsizelimit.md)
...
🔗 [**Подробнее: Предотвращайте ваше однопоточное выполнение от перегрузки злонамеренным RegEx**](./sections/security/regex.md)
...
🔗 [**Подробнее: Избегайте загрузки модулей с использованием переменных**](./sections/security/safemoduleloading.md)
...
🔗 [**Подробнее: Изменяйте настройки промежуточного программного обеспечения сеанса по умолчанию**](./sections/security/sessions.md)
...
🔗 [**Подробнее: Избегайте публикации секретов в реестре npm**](./sections/security/avoid_publishing_secrets.md)
<br/><br/><br/>
...
🔗 [**Read More: Не блокируйте цикл событий**](./sections/performance/block-loop.md)
...
🔗 [**Подробнее: Предпочитайте нативные методы JS над пользовательскими утилитами, такими как Lodash**](./sections/performance/nativeoverutil.md)
...
- ![RU](./assets/flags/RU.png) [Russian](./README.md) - Любезно предоставлено [Alex Ivanov](https://github.com/contributorpw)
...
- ![KR](./assets/flags/KR.png) [Korean](./README.md) - Любезно предоставлено [Sangbeom Han](https://github.com/uronly14me) ([Discussion](https://github.com/goldbergyoni/nodebestpractices/issues/94))
