...
## ![✔](./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png)(./assets/images/checkbox-small-blue.png) 1.1 Organisez votre projet en composants
...
🔗 [**Plus d'infos : organisez en composants**](./sections/projectstructre/breakintcomponents.md)
...
🔗 [**Plus d'infos : organisez en strates votre app**](./sections/projectstructre/createlayers.md)
...
🔗 [**Plus d'infos : organisez par fonction**](./sections/projectstructre/wraputilities.md)
...
🔗 [**Plus d'infos : séparez Express 'app' et 'server'**](./sections/projectstructre/separateexpress.md)
...
🔗 [**Plus d'infos : bonnes pratiques de configuration**](./sections/projectstructre/configguide.md)
...
🔗 [**Plus d'infos : évitez les fonctions de rappel**](./sections/errorhandling/asyncerrorhandling.md)
...
🔗 [**Plus d'infos : utilisez uniquement l'objet intégré Error**](./sections/errorhandling/useonlythebuiltinerror.md)
...
🔗 [**Plus d'infos : erreur opérationnelle vs erreur de programmation**](./sections/errorhandling/operationalvsprogrammererror.md)
...
🔗 [**Plus d'infos : gestion des erreurs dans un lieu centralisé**](./sections/errorhandling/centralizedhandling.md)
...
🔗 [**Plus d'infos : documentez les erreurs de l'API à l'aide de Swagger ou GraphQL**](./sections/errorhandling/documentingusingswagger.md)
...
🔗 [**Plus d'infos : arrêtez le processus**](./sections/errorhandling/shuttingtheprocess.md)
...
🔗 [**Plus d'infos : utilisation d'un outil de journalisation mature**](./sections/errorhandling/usematurelogger.md)
...
🔗 [**Plus d'infos : test des flux d'erreurs**](./sections/errorhandling/testingerrorflows.md)
...
🔗 [**Plus d'infos : utilisation des produits GPA**](./sections/errorhandling/apmproducts.md)
...
🔗 [**Plus d'infos : capturez les rejets de promesses non gérés**](./sections/errorhandling/catchunhandledpromiserejection.md)
...
🔗 [**Plus d'infos : échec rapide**](./sections/errorhandling/failfast.md)
...
🔗 [**Plus d'infos : le retour des promesses**](./sections/errorhandling/returningpromises.md)
...
🔗 [**Plus d'infos : Utilisez ESLint et Prettier**](./sections/codestylepractices/eslint_prettier.md)
...
🔗[**Plus d'infos : incluez 3 parties dans chaque nom de test**](./sections/testingandquality/3-parts-in-name.md)
...
🔗[**Plus d'infos : structurez vos tests avec le format AAA**](./sections/testingandquality/aaa.md)
...
🔗[**Plus d'infos : évitez les tests globaux, ajoutez des données pour chaque test**](./sections/testingandquality/avoid-global-test-fixture.md)
...
🔗[**Plus d'infos: refactorisation !**](./sections/testingandquality/refactoring.md)
...
🔗[**Plus d'infos : choisissez soigneusement votre plateforme CI**](./sections/testingandquality/citools.md)
...
🔗 [**Plus d'infos : testez vos middlewares de manière isolée**](./sections/testingandquality/test-middlewares.md)
...
🔗 [**Plus d'infos : surveillance !**](./sections/production/monitoring.md)
...
🔗 [**Plus d'infos : augmentez la clarté à l'aide de la journalisation intelligente**](./sections/production/smartlogging.md)
...
🔗 [**Plus d'infos : déléguez tout ce qui est possible (par exemple gzip, SSL) à un proxy inverse**](./sections/production/delegatetoproxy.md)
...
🔗 [**Plus d'infos : verrouillez les dépendances**](./sections/production/lockdependencies.md)
...
🔗 [**Plus d'infos : protégez la disponibilité du processus avec des bons outils**](./sections/production/guardprocess.md)
...
🔗 [**Plus d'infos : utilisez tous les cœurs du CPU**](./sections/production/utilizecpu.md)
...
🔗 [**Plus d'infos : créez un « point de terminaison de maintenance »**](./sections/production/createmaintenanceendpoint.md)
...
🔗 [**Plus d'infos : découvrez les erreurs et les indisponibilités à l'aide des produits APM**](./sections/production/apmproducts.md)
...
🔗 [**Plus d'infos : préparez votre code pour la production**](./sections/production/productioncode.md)
...
🔗 [**Plus d'infos : mesurez et protégez l'utilisation de la mémoire**](./sections/production/measurememory.md)
...
🔗 [**Plus d'infos : retirez vos ressources frontend de Node**](./sections/production/frontendout.md)
...
🔗 [**Plus d'infos : soyez sans état, tuez vos serveurs presque tous les jours**](./sections/production/bestateless.md)
...
🔗 [**Plus d'infos : Utilisez des outils qui détectent automatiquement les vulnérabilités**](./sections/production/detectvulnerabilities.md)
...
🔗 [**Plus d'infos : attribuez un ‘TransactionId’ à chaque relevé du journal**](./sections/production/assigntransactionid.md)
...
🔗 [**Plus d'infos : définissez NODE_ENV=production**](./sections/production/setnodeenv.md)
...
🔗 [**Plus d'infos : Utilisez une version LTS de Node.js**](./sections/production/LTSrelease.md)
...
🔗 [**Plus d'infos : redirection du journal**](./sections/production/logrouting.md)
...
🔗 [**Plus d'infos : utilisez npm ci**](./sections/production/installpackageswithnpmci.md)
...
🔗 [**Plus d'infos : régles du linter**](./sections/security/lintrules.md)
...
🔗 [**Plus d'infos : mettez en œuvre la limitation de débit**](./sections/security/limitrequests.md)
...
🔗 [**Plus d'infos : gestion des secrets**](./sections/security/secretmanagement.md)
...
🔗 [**Plus d'infos : Prévention de l'injection de queries à l'aide des bibliothèques ORM/ODM**](./sections/security/ormodmusage.md)
...
🔗 [**Plus d'infos : les meilleures pratiques communes en matière de sécurité**](./sections/security/commonsecuritybestpractices.md)
...
🔗 [**Plus d'infos : utilisation d'entêtes sécurisés dans votre application**](./sections/security/secureheaders.md)
...
🔗 [**Plus d'infos : sécurité des dépendances**](./sections/security/dependencysecurity.md)
...
🔗 [**Plus d'infos : mots de passe utilisateur**](./sections/security/userpasswords.md)
...
🔗 [**Plus d'infos : échappez la sortie**](./sections/security/escape-output.md)
...
🔗 [**Plus d'infos : validez les schémas JSON entrants**](./sections/security/validation.md)
...
🔗 [**Plus d'infos : bloquez les jetons Web JSON**](./sections/security/expirejwt.md)
...
🔗 [**Plus d'infos : restrictions du nombre de connexions**](./sections/security/login-rate-limit.md)
...
🔗 [**Plus d'infos : exécutez Node.js en tant qu'utilisateur non root**](./sections/security/non-root-user.md)
...
🔗 [**Plus d'infos : limitez la capacité des données utiles**](./sections/security/requestpayloadsizelimit.md)
...
🔗 [**Plus d'infos : évitez les instruction eval de JavaScript**](./sections/security/avoideval.md)
...
🔗 [**Plus d'infos : empêcher une RegEx malveillante**](./sections/security/regex.md)
...
🔗 [**Plus d'infos : chargement sécurisé des modules**](./sections/security/safemoduleloading.md)
...
🔗 [**Plus d'infos : exécutez un code dangereux dans un bac à sable**](./sections/security/sandbox.md)
...
🔗 [**Plus d'infos : soyez prudents lorsque vous travaillez avec des processus fils**](./sections/security/childprocesses.md)
...
🔗 [**Plus d'infos : masquez les détails des erreurs au client**](./sections/security/hideerrors.md)
...
🔗 [**Plus d'infos : cookie et sécurité des sessions**](./sections/security/sessions.md)
...
🔗 [**Plus d'infos : empêchez les redirections dangereuses**](./sections/security/saferedirects.md)
...
🔗 [**Plus d'infos : évitez de publier des secrets**](./sections/security/avoid_publishing_secrets.md)
<br/><br/><br/>
...
🔗 [**Plus d'infos : ne bloquez pas la boucle d'événement**](./sections/performance/block-loop.md)
...
🔗 [**Plus d'infos : natif supérieur aux utilitaires**](./sections/performance/nativeoverutil.md)
...
🔗 [**Plus d'infos : utilisez multi-stage builds**](./sections/docker/multi_stage_builds.md)
...
[**Plus d'infos : Démarrez un conteneur à l'aide de la commande node, évitez npm start**](./sections/docker/bootstrap-using-node.md)
...
🔗 [**Plus d'infos : laissez l'orchestrateur Docker redémarrer et répliquer les processus**](./sections/docker/restart-and-replicate-processes.md)
...
🔗 [**Plus d'infos : utilisez .dockerignore**](./sections/docker/docker-ignore.md)
...
🔗 Plus d'infos : [supprimez les dépendances de développement](./sections/docker/install-for-production.md)
...
🔗 [**Plus d'infos : arrêt progressif**](./sections/docker/graceful-shutdown.md)
...
🔗 [**Plus d'infos : définissez des limites de mémoire en utilisant uniquement Docker**](./sections/docker/memory-limit.md)
...
🔗 [**Plus d'infos : exploiter la mise en cache pour réduire les temps de construction**](./sections/docker/use-cache-for-shorter-build-time.md)
...
🔗 [**Plus d'infos : Comprendre les tags d'image et utiliser le tag "latest" avec précaution**](./sections/docker/image-tags.md)
...
🔗 [**Plus d'infos : privilégiez les plus petites images**](./sections/docker/smaller_base_images.md)
...
🔗 [**Plus d'infos : nettoyez les secrets de construction**](./sections/docker/avoid-build-time-secrets.md)
...
🔗 [**Plus d'infos : scannez l'ensemble de l'image avant la production**](./sections/docker/scan-images.md)
...
🔗 [**Plus d'infos : nettoyez le cache NODE_MODULE**](./sections/docker/clean-cache.md)
...
🔗 [**Plus d'infos : les pratiques de Docker en général**](./sections/docker/generic-tips.md)
...
🔗 [**Plus d'infos : lintez your Dockerfile**](./sections/docker/lint-dockerfile.md)
...
- ![FR](./assets/flags/FR.png) [Français](https://github.com/gaspaonrocks/nodebestpractices/blob/french-translation/README.md) ([Discussion](https://github.com/goldbergyoni/nodebestpractices/issues/129))
