...
**TL;DR:** Логіка обробки помилок, як-от надсилання пошти адміністратору та ведення журналу, повинна бути інкапсульована в виділеному та централізованому об’єкті, який усі кінцеві точки (наприклад, проміжне програмне забезпечення Express, cron, модульне тестування) викликають у разі виникнення помилки
