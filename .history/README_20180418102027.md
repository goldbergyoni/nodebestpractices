...
**Otherwise:** An attacker who manage to run a script on the server gets unlimited power over the local machine (e.g. change iptable and re-route traffic to his serve) He may change the iptable, 
