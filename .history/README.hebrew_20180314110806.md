...
**2. זהו המאגר הגדול ביותר של בסט פרקטיס והוא גדל בכל חודש -** כרגע מופיעים מעל 50 בסט פרקטיס, עיצות שונות ומדריך לתיכנון וארכיטקטורה של אפליקציות בנודג'. הקהילה מוסיפה באופן קבוע Issues & PR We'd love to see you contributing here, whether fixing some  code mistake or suggesting brilliant new ideas. See our [milestones here](https://github.com/i0natan/nodebestpractices/milestones?direction=asc&sort=due_date&state=open)
