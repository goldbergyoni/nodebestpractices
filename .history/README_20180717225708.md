...
**TL;DR:** Though any step in the development chain should be protected with MFA (multi-factor authentication), NPM/Yarn are a sweet opportunity for attackers, who gain  to inject malicious code that is widely installed across projects and Microservices. Enabling 2 factor authentication 
