...
**TL;DR:** Untrusted data that is sent down to the browser might get executed instead of just being displayed. Mitigate this by using dedicated libraries that explicitly mark the data as pure content (i.e. escaping)
