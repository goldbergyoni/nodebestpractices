...
class travellingRecommender {
  isItRecommended(countries, numberOfDays) {
    ...
    this.checkHolidays(countries[0], "03/01/2018")
  ...
  checkHolidays(country, numberOfDays){
    ...
    const isHoliday = holidaysList.isHoliday(new Date("2018-03-01 00:00:00"));
...
new travellingRecommender().isItRecommended(["Israel"], 3);