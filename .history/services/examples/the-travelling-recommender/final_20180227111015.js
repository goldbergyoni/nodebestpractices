...
class travellingRecommender{
  ...
  const holidaysList = new Holidays("US");
  const allHolidays = holidaysList.Holidays(2018)
  console.log(cityInfo[0].country);
  const isHoliday = holidaysList.isHoliday(new Date('2018-25-12 00:00:00 GMT+0000'))
