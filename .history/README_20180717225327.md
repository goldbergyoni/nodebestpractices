...
**TL;DR:** Though any step in the development chain should be protected with MFA (multi-factor authentication), NPM/Yarn are the greatest opprtunity for attackers to inject malicious code that is widely installed
