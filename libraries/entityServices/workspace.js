...
class Workspace {
  ...
  {
    return new Workspace(workspaceGist.organizationId, workspaceGist.userId, workspaceGist.userRoles, workspaceGist.language);
  }
  constructor(organizationId, userId, userRoles, language) {
